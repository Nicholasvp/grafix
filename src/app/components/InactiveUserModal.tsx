...
export default function InactiveUserModal({ isOpen, onClose }: InactiveUserModalProps) {
          ...
          <div className="mt-3 text-center sm:mt-5">
            ...
            <div className="mt-2">
              <p className="text-sm text-gray-500">
                Sua conta não está ativa no sistema. Entre em contato com o administrador do sistema para reativar sua conta.
              </p>
            </div>
          </div>
